...
export const Route = createFileRoute('/(demo)/request-access-demo/')({
  component: RequestAccessDemoPage,
})
...
function RequestAccessDemoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Step 2: Submitting request (Mock)
       await new Promise((resolve) => setTimeout(resolve, 500))
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4 gap-4">
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle>Request Access (Demo)</CardTitle>
            <CardDescription>
